...
/* globals contract, Node, ExpensiveFactory, NodeData, TokenLedger, ExpensiveParent, ParentResolver, web3, assert
*/

var testHelper = require('./test-helper.js');
contract('ExpensiveFactory', function (accounts) {
  ...
  before(function(done){
    parent = ExpensiveParent.deployed();
    ...
    nodeFactory = ExpensiveFactory.deployed();
  ...
  beforeEach(function(done){
    ...
    .then(function(node_){
      console.log('Node address: ', node_);
      node = Node.at(node_);
