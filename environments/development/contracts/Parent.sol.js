...
(function() {
  ...
  var contract_data = {
    abi: [{"constant":true,"inputs":[{"name":"_key","type":"bytes32"}],"name":"getNode","outputs":[{"name":"","type":"address"}],"type":"function"},{"constant":false,"inputs":[{"name":"_key","type":"bytes32"},{"name":"NodeTemplateAddress_","type":"address"}],"name":"upgradeNode","outputs":[],"type":"function"},{"constant":false,"inputs":[{"name":"key_","type":"bytes32"}],"name":"createNode","outputs":[],"type":"function"},{"constant":false,"inputs":[{"name":"key_","type":"bytes32"}],"name":"removeNode","outputs":[],"type":"function"},{"constant":true,"inputs":[],"name":"organisationFactory","outputs":[{"name":"","type":"address"}],"type":"function"},{"constant":false,"inputs":[{"name":"_FactoryAddress","type":"address"}],"name":"registerFactory","outputs":[],"type":"function"}],
